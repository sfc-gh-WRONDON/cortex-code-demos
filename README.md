...
```
cortex-code-demos/
├── cardworks/          — Data engineering & pipeline monitoring (dbt, migrations, Streamlit)
└── arpu-intelligence/  — Cortex AI & ML for creator platforms (ML, Agents, Streamlit)
```
...
See [cardworks/Notes_v3.md](cardworks/Notes_v3.md) for the full timed demo script.
...
└── cortex-ai-overview.html      — Cortex AI overview presentation
```
